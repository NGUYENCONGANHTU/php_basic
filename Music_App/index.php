...
<body>
    ...
    <section class="container mx-auto mt-5 px-4">
        <h2 class="text-2xl font-bold mb-4">Danh mục âm nhạc</h2>
        <div class="grid grid-cols-3 gap-4">
            <?php foreach ($categories as $category) : ?>
            <div class="p-4 border border-gray-300 rounded-md text-center font-bold">
                <a href="song.php?category=<?php echo urlencode($category['name']); ?>">
